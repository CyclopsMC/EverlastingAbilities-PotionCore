...
public class GeneralConfig extends DummyConfig {
    ...
    public GeneralConfig() {
        super(EverlastingAbilitiesPotionCore._instance, true, "general", null, GeneralConfig.class);
    }
    ...
    public void onRegistered() {
        ...
        if(versionChecker) {
            Versions.registerMod(getMod(), EverlastingAbilitiesPotionCore._instance, Reference.VERSION_URL);
        }
    }
