...
public class Reference {
    ...
    public static final String GA_TRACKING_ID = "UA-65307010-20";
    public static final String VERSION_URL = "https://raw.githubusercontent.com/CyclopsMC/Versions/master/1.12/EverlastingAbilities-PotionCore.txt";
