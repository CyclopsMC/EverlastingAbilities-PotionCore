 ...
 *
 */
public class AbilityInvertConfig extends AbilityConfig {
    ...
    protected IConfigurable initSubInstance() {
        return new AbilityTypePotionEffectRadius(getNamedId(), rarity, maxLevel, xpPerLevel, PotionInvert.INSTANCE, true);
    }
}
