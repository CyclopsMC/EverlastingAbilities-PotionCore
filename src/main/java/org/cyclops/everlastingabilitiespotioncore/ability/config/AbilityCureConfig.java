 ...
 *
 */
public class AbilityCureConfig extends AbilityConfig {
    ...
    protected IConfigurable initSubInstance() {
        return new AbilityTypePotionEffectSelf(getNamedId(), rarity, maxLevel, xpPerLevel, PotionCure.INSTANCE);
    }
}
