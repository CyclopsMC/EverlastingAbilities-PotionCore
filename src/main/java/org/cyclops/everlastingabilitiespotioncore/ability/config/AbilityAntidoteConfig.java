 ...
 *
 */
public class AbilityAntidoteConfig extends AbilityConfig {
    ...
    protected IConfigurable initSubInstance() {
        return new AbilityTypePotionEffectSelf(getNamedId(), rarity, maxLevel, xpPerLevel, PotionAntidote.INSTANCE);
    }
}
