 ...
 *
 */
public class AbilityDisorganizationConfig extends AbilityConfig {
     ...
     * Make a new instance.
     */
    public AbilityDisorganizationConfig() {
        super(
                false,
                "disorganization",
    ...
    protected IConfigurable initSubInstance() {
        return new AbilityTypePotionEffectRadius(getNamedId(), rarity, maxLevel, xpPerLevel, PotionDisorganization.INSTANCE, true);
    }
}
