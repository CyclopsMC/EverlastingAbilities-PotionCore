 ...
 *
 */
public class AbilityDiamondSkinConfig extends AbilityConfig {
    ...
    public static int xpPerLevel = 60;
     ...
     * Make a new instance.
     */
    public AbilityDiamondSkinConfig() {
        super(
                true,
                "diamond_skin",
    ...
    protected IConfigurable initSubInstance() {
        return new AbilityTypePotionEffectSelf(getNamedId(), rarity, maxLevel, xpPerLevel, PotionDiamondSkin.INSTANCE);
    }
}
