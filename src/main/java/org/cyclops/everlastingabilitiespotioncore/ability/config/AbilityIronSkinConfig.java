 ...
 *
 */
public class AbilityIronSkinConfig extends AbilityConfig {
    ...
    protected IConfigurable initSubInstance() {
        return new AbilityTypePotionEffectSelf(getNamedId(), rarity, maxLevel, xpPerLevel, PotionIronSkin.INSTANCE);
    }
}
